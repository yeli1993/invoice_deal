package com.hanmanyi.invoice.check;
...
/**
 * 用友API Link 查验接口
 * 价格：0.200元/次 ~ 0.110元/次 买的越多，价格越便宜
 * 购买地址：https://api.yonyoucloud.com/apilink/tempServicePages/20d8711d-a13b-4e47-b6b6-b2d2f1b38472_true.html
 * @author 皮球爸爸
 *
 */
public class CheckDemo {
    ...
    //1.API方法
    public static void getRequest(String code){
        String result =null;
        String url ="https://api.yonyoucloud.com/apis/dst/verifyInvoiceWithType/verifyInvoiceWithCode";//请求接口地址
        String method = "POST";
    ...
    public static void main(String[] args) {
        getRequest("01,10,013001920011,78984700,87.43,20200707,52899946032941310468,0373,");
    }
}
